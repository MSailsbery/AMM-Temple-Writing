...
The Weighted Distance Model is used to minimize the average distance from members to their nearest temple within the United States.
...
Section \ref{sec:models} will examine three modeling approaches to the problem; namely, a Weighted Distance model, a Markov chain model, and ... %TODO- Decide on last model.
