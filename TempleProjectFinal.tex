...
%include some things about the toy test cases, maybe a plot (subplot 3, graph on top of each other)
%4 subplots with circles, euclidian as control
%reference the plot in each subsection
