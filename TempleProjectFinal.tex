...
In fact, Current, Min and Schilling cite a recent bibliography on this subject that had over 1500 titles, showing the vast expanse of research in this area (1990). %it's great they cite it, should we cite it directly?
% In regards to above, I don't have access to this article anymore. But if someone does, I'll change the reference. - McKell
...
Approaches such as interval optimization (Yadav, Karmakar, Dikshit, Bhurjee, 2018), iterative goal programming (Karatas, Yakici, 2018), hyper heuristics with space reductions (Ren, Jiang, Xuan, Luo, 2010), and ... have been used.
...
\bibitem[Agra, Cerdeira, Requejo, 2017]{Agra:2017}
...
\bibitem[Ren, Jiang, Xuan, Luo, 2010]{Ren:2010}
...
\bibitem[Yadav, Karmakar, Dikshit, Bhurjee, 2018]{Yadav:2018}
